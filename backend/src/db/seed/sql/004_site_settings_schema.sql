...
('ss-site-logo',         'site_logo',         '*', '"/assets/woody/woody-and-friends-logo.png"'),
('ss-site-logo-dark',    'site_logo_dark',    '*', '"/assets/woody/woody-and-friends-logo.png"'),
('ss-site-logo-light',   'site_logo_light',   '*', '"/assets/woody/woody-and-friends-logo.png"'),
