...
('ss-ui-admin-config', 'ui_admin_config', '*', '{"branding":{"app_name":"Woody Admin","app_copyright":"Woody and Friends","html_lang":"tr","theme_color":"#FF6A00","favicon_16":"/favicon/favicon-16.svg","favicon_32":"/favicon/favicon-32.svg","favicon_url":"/favicon.ico","logo_url":"/assets/woody/woody-and-friends-flat.png","apple_touch_icon":"/favicon/apple-touch-icon.svg","admin_login_quote":"Okul oncesi Ingilizce, hikaye ve dijital ogrenme iceriklerini buradan yonetin.","admin_login_heading":"Woody dunyasina hos geldiniz","admin_login_background_url":"/assets/woody/sections/hero-poster.webp","meta":{"title":"Woody Admin","description":"Woody Admin yonetim paneli.","og_url":"http://localhost:3096","og_title":"Woody Admin","og_description":"Woody Admin yonetim paneli.","og_image":"/favicon.svg","twitter_card":"summary_large_image"}}}'),
('ss-ui-admin-pages-tr', 'ui_admin_pages', 'tr', '{"dashboard":{"title":"Kontrol Paneli","description":"Genel durum ve hızlı erişimler."},"storage":{"title":"Dosya Yöneticisi","description":"Görselleri ve medya dosyalarını yönetin."},"home_layout":{"title":"Anasayfa Düzeni","description":"Anasayfa bölümlerini sıralayın ve düzenleyin."},"site_settings":{"title":"Site Ayarları","description":"Marka, SEO, yerelleştirme ve entegrasyon ayarları."}}');
