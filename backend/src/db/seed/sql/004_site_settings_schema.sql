...
-- Marka metni: Woody ve Arkadaşları tokeni — scripts/apply-brand.py ile proje adina cevrilir
-- =============================================================
...
('ss-brand-name',        'brand_name',        '*', '"Woody ve Arkadaşları"'),
('ss-brand-subtitle',    'brand_subtitle',    '*', '"Kurumsal web, icerik ve yonetim"'),
('ss-brand-short-name',  'brand_short_name',  '*', '"Woody ve Arkadaşları"'),
('ss-topbar-slogan',     'topbar_slogan',     '*', '"Guvenilir icerik ve hizmet"'),
('ss-app-name',          'app_name',          '*', '"Woody ve Arkadaşları"'),
('ss-app-version',       'app_version',       '*', '"0.1.0"'),
('ss-default-locale',    'default_locale',    '*', '"tr"'),
('ss-available-locales', 'available_locales', '*', '["tr"]'),
('ss-footer-copyright',  'footer_copyright',  '*', '"© 2026 Woody ve Arkadaşları. Tum haklari saklidir."'),
('ss-footer-keywords',   'footer_keywords',   '*', '["web","icerik","yonetim","Woody ve Arkadaşları"]'),
...
('ss-site-logo',         'site_logo',         '*', '""'),
('ss-site-logo-dark',    'site_logo_dark',    '*', '""'),
('ss-site-logo-light',   'site_logo_light',   '*', '""'),
('ss-contact-info',      'contact_info',      '*', '{}'),
('ss-socials',           'socials',           '*', '{}'),
('ss-company-brand',     'company_brand',     '*', '{"name":"Woody ve Arkadaşları","website":"","phone":"","email":"","socials":{}}'),
...
('ss-ui-admin-config', 'ui_admin_config', '*', '{"branding":{"app_name":"Woody ve Arkadaşları Admin","app_copyright":"Woody ve Arkadaşları","html_lang":"tr","theme_color":"#15803d","favicon_16":"/favicon/favicon-16.svg","favicon_32":"/favicon/favicon-32.svg","favicon_url":"/favicon.ico","logo_url":"","apple_touch_icon":"/favicon/apple-touch-icon.svg","admin_login_quote":"Site ayarlarini ve icerigi buradan yonetin.","admin_login_heading":"","admin_login_background_url":"/img/admin_login_bg.png","meta":{"title":"Woody ve Arkadaşları Admin","description":"Yonetim paneli.","og_url":"http://localhost:3096","og_title":"Woody ve Arkadaşları Admin","og_description":"Yonetim paneli.","og_image":"/favicon.svg","twitter_card":"summary_large_image"}}}');
