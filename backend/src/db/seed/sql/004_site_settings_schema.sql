...
('ss-site-logo',         'site_logo',         '*', '"/uploads/brand/logo-primary.svg"'),
('ss-site-logo-dark',    'site_logo_dark',    '*', '"/uploads/brand/logo-dark.svg"'),
('ss-site-logo-light',   'site_logo_light',   '*', '"/uploads/brand/logo-white.svg"'),
