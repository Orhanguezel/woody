    ...
    <main className="bg-white pt-28 text-gray-900">
      <section className="container grid gap-10 pb-16 lg:grid-cols-[0.95fr_1.05fr] lg:items-start">
        ...
        <div>
          ...
          {product.purchaseMode === 'online' && !product.isFree && formattedPrice ? (
            <div className="mt-6 flex flex-wrap items-center gap-3">
              <span className="font-display text-3xl font-black text-brand-primary">{formattedPrice}</span>
              {minQuantityText ? (
