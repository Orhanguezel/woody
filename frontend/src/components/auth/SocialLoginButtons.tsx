      ...
      <div className={containerCls}>
        {canUseGoogle && (
          <button
            ...
            disabled={isLoading}
            className={`inline-flex items-center justify-center gap-3 rounded-sm border border-(--gm-border-soft) bg-(--gm-surface) px-4 py-3 text-sm font-medium text-(--gm-text) transition-all hover:border-(--gm-gold)/40 hover:bg-(--gm-surface) hover:shadow-sm disabled:cursor-not-allowed disabled:opacity-60 ${FOCUS_RING}`}
            aria-label="Google ile devam et"
          >
            <Image src="/icons/google.png" alt="" width={18} height={18} aria-hidden />
        ...
        {canUseFacebook && (
          ...
          >
            <Image src="/icons/facebook.png" alt="" width={18} height={18} aria-hidden />
        ...
        {canUseApple && (
          ...
          >
            <svg viewBox="0 0 384 512" width={18} height={18} fill="currentColor" className="text-(--gm-text)" aria-hidden>
