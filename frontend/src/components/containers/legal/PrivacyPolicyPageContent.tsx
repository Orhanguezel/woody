...
const PrivacyPolicyPageContent: React.FC = () => {
  ...
  const title = useMemo(() => {
    ...
    return (
      t ||
      String(ui('ui_privacy_policy_fallback_title', 'Gizlilik Politikası') || '').trim() ||
      'Gizlilik Politikası'
    );
  }, [page, ui]);
        ...
        {!isLoading && (isError || !page) && (
          <div className="max-w-4xl mx-auto text-center py-20">
            <div
              ...
              role="alert"
            >
              {ui('ui_privacy_policy_empty', 'İçerik henüz hazırlanmadı.')}
            </div>
          </div>
        )}
          ...
          <div className="max-w-4xl mx-auto">
            ...
            {html ? (
              ...
              <div
                ...
                role="alert"
              >
                {ui('ui_privacy_policy_empty_text', 'Bu bölümün içeriği yakında eklenecektir.')}
              </div>
            )}
