> **10 Eylül birleşik çeklist:** Bu belgedeki açık maddeler sahip ve kanıtla [WOODY-BIRLESIK-CEKLIST-2026-09-10.md](WOODY-BIRLESIK-CEKLIST-2026-09-10.md) altında toplandı. **Kritik:** 8 Eylül 15:02 UTC build'i canonical/hreflang/sitemap'i `http://localhost` yapmıştı; 10 Eylül'de düzeltildi (`81c897b`). Aşağıdaki canonical "[x]" işareti o build'den öncedir.
