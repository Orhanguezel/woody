      ...
      <div className="grid lg:grid-cols-[280px_1fr] gap-8 items-start">
        ...
        <aside className="space-y-6">
                    ...
                    <div className="flex items-center gap-3">
                      <item.icon
                        className={cn(
                          ...
                          isActive ? "text-gm-gold" : "text-gm-muted/70 group-hover:text-gm-text/70",
                        )}
                      />
          ...
          <Card className="bg-gm-gold/[0.02] border border-gm-gold/10 rounded-[32px] p-8 text-center space-y-4 backdrop-blur-sm shadow-inner">
            ...
            <h4 className="font-serif text-lg text-gm-text">
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center gap-2">
                ...
                {!isGlobalTab && (
                  <Badge
                    variant="outline"
                    className="border-gm-gold/30 bg-gm-gold/5 text-gm-gold px-4 py-1.5 text-[9px] font-bold uppercase tracking-[0.2em]"
                  >
                    {locale}
                  </Badge>
                )}
