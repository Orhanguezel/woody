...
export type SmtpSettingsTabProps = {
  ...
  /**
   * Kartın kendi başlığını (CardHeader) gösterir. Dedike /admin/mail sayfası
   * gibi üstte zaten gm-theme sayfa başlığı olan yerlerde false verilir.
   */
  showHeader?: boolean;
};
...
export const SmtpSettingsTab: React.FC<SmtpSettingsTabProps> = ({ locale, showHeader = true }) => {
        ...
        <div className="grid grid-cols-1 gap-6 md:grid-cols-12">
          ...
          <div className="flex items-end md:col-span-3">
            <div className="flex items-center space-x-3 bg-gm-surface/20 border border-gm-border-soft rounded-2xl p-3 h-12 w-full px-5">
              ...
              <Label
                htmlFor="smtp-ssl"
                className="text-[10px] font-bold text-gm-muted tracking-[0.15em] uppercase cursor-pointer"
              >
        ...
        <div className="bg-gm-surface/30 border border-gm-border-soft rounded-[24px] p-6">
          <div className="grid grid-cols-1 items-end gap-6 md:grid-cols-2">
            ...
            <div className="flex flex-col sm:flex-row justify-end gap-3">
              ...
              >
                {isTesting
                  ? t("admin.siteSettings.smtp.sendingTest", null, "Test Gönderiliyor...")
                  : t("admin.siteSettings.smtp.sendTest", null, "Test Gönder")}
              </Button>
