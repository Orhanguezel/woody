...
import { Code, RefreshCcw, Save } from "lucide-react";
      ...
      <CardContent className="p-8 space-y-6">
        <div className="space-y-4">
          ...
          <div className="mt-4 flex items-center gap-3 px-2">
            <Badge
              variant="outline"
              className="border-gm-gold/30 bg-gm-gold/5 text-gm-gold px-2 py-0.5 text-[9px] font-bold uppercase tracking-[0.2em]"
            >
