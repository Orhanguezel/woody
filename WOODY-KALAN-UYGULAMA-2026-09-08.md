...
GA4 anahtarı 8 Eylül son kontrolünde bağlandı; sunucu işleyicisi ve purchase/refund doğrulama testi geçti. Gerçek yeni ödeme/iadenin GA4 raporunda görülmesi, kimlik rotasyonu, reklam apply onayı ve işletme maliyet/SLA/ürün teyitleri açık. Ayrıntı: WOODY-GA4-ANAHTAR-DOGRULAMA-2026-09-08.md. Sayısal AI taslakları karar girdisinden korunuyor. Ardından Tanitio `7fde188` ile atomik insan düzeltmesi, supersedes geçmişi ve arşiv kaydı koruması da yayımlandı; dashboard build `O-mLRblY4wVOhRAwoGOzE`. Hatalı kayıt açıklayıcı düzeltmeye bağlandı; finansın üç hata senaryosu tekrar geçti.
